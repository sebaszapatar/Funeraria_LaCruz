...
namespace Funeraria_LaCruz.API.Migrations
{
    ...
    [Migration("20230519193522_DbFunerariaV4")]
    partial class DbFunerariaV4
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Funeraria_LaCruz.Shared.Entities.Country", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Funeraria_LaCruz.Shared.Entities.Deceased", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Funeraria_LaCruz.Shared.Entities.Employee", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Funeraria_LaCruz.Shared.Entities.Plan", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Funeraria_LaCruz.Shared.Entities.User", b =>
                {
            ...
            modelBuilder.Entity("Funeraria_LaCruz.Shared.Entities.City", b =>
                {
                    b.HasOne("Funeraria_LaCruz.Shared.Entities.State", "State")
                        .WithMany("Cities")
            ...
            modelBuilder.Entity("Funeraria_LaCruz.Shared.Entities.State", b =>
                {
                    b.HasOne("Funeraria_LaCruz.Shared.Entities.Country", "Country")
                        .WithMany("States")
            ...
            modelBuilder.Entity("Funeraria_LaCruz.Shared.Entities.User", b =>
                {
                    b.HasOne("Funeraria_LaCruz.Shared.Entities.City", "City")
                        .WithMany("Users")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Funeraria_LaCruz.Shared.Entities.User", null)
                        .WithMany()
